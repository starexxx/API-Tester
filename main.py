...
<head>
    ...
    <style>
        ...
        :root { --primary: #007AFF; --secondary: #8E8E93; --background: #000; --surface: #121212; --text: #fff; --text-secondary: #aaa; --ripple: rgba(0, 122, 255, 0.15); --border: rgba(255,255,255,0.3); --danger: #FF3B30; --success: #34C759; --warning: #FF9500; }
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'SF Pro Display', -apple-system, BlinkMacSystemFont, sans-serif; -webkit-tap-highlight-color: transparent; }
        ...
        .header { border-bottom: 1px solid #303030; background: var(--surface); color: var(--text); display: flex; align-items: center; padding: 15px; font-size: 17px; font-weight: 600; position: sticky; top: 0; z-index: 10; box-shadow: 0 1px 0 rgba(0,0,0,0.05); }
        ...
        select, input, textarea { width: 100%; padding: 12px 16px; font-size: 17px; border: 1px solid var(--border); border-radius: 10px; outline: none; background: var(--surface); color: white; -webkit-appearance: none; }
